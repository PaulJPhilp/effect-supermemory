 ...
 * ```
 */
export const createNamespacedKey = (namespace, key) => `${namespace}:${key}`;
/**
 ...
 * ```
 */
export const createMemoryItem = (key, value) =>
 ...
 * ```
 */
export const extractKeyFromNamespaced = (namespacedKey) => {
 ...
 * ```
 */
export const isNamespacedKey = (key) =>
